...
/**
 * Class to run the tests using {@link SynchronousSPFExecutor}
 */
public class SynchronousSPFExecutorIntegrationTest extends SPFExecutorBaseTest {
    @BeforeClass
    ...
    protected SPF createSPF() {
        return DefaultSPF.createSync();
    }

    @Override
    protected SPF createCustomSPF(DNSService dnsService) {
        return new SPF(dnsService, new SynchronousSPFExecutor(dnsService));
    }
}