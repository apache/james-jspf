...
public class SPFMailZoneTest extends TestCase {

    public SPFMailZoneTest(String name) throws IOException {
        super(name);
    ...
    public SPFMailZoneTest(SPF spf, SPFTestDef def) {
        super(def.name);
        this.spf = spf;
        this.data = def;
    }
    ...
    public static List loadTests() throws IOException {
        ...
        BufferedReader br = new BufferedReader(new InputStreamReader(
                SPFMailZoneTest.class.getResourceAsStream("test_mailzone.txt")));
