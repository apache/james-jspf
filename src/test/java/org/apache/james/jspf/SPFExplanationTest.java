...
public class SPFExplanationTest extends TestCase {

    public SPFExplanationTest(String name) throws IOException {
        super(name);
    ...
    public SPFExplanationTest(SPF spf, SPFTestDef def) {
        super(def.name);
        this.spf = spf;
        this.data = def;
    }
    ...
    public static List loadTests() throws IOException {
        ...
        BufferedReader br = new BufferedReader(new InputStreamReader(
                SPFExplanationTest.class.getResourceAsStream("test_explanation.txt")));
    ...
    static class SPFSuite extends TestSuite {
        ...
        public SPFSuite() throws IOException {
            ...
            while (i.hasNext()) {
                addTest(new SPFExplanationTest(spf, (SPFTestDef) i.next()));
            }
        }
