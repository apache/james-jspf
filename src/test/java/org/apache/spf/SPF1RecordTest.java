...
public class SPF1RecordTest extends TestCase {

    public SPF1RecordTest(String name) throws IOException {
        super(name);
    ...
    public SPF1RecordTest(SPF1RecordTestDef def) {
        super(def.recIn);
        this.data = def;
    }
    ...
    protected void runTest() throws Throwable {
        ...
        try {
            ...
            SPF1Record r = new SPF1Record(data.recIn, d);

            r.runCheck();

            if (r.getWarning() != null) {
                assertEquals("Expected <" + data.errMsg + "> but was <"
                        + r.getWarning() + ">", data.errMsg, r.getWarning());
            } else {
                System.err.println("NO Exception: " + data.recIn + " => "
                        + data.errMsg + " ===> " + r.getExplanation());
                assertEquals("Expected Error " + data.errMsg, "no errors",
                        data.errMsg);
            }
    ...
    public static HashMap loadTests() throws IOException {
        ...
        BufferedReader br = new BufferedReader(new InputStreamReader(
                SPF1RecordTest.class.getResourceAsStream("test_parser.txt")));
    ...
    static class SPF1RecordTestSuite extends TestSuite {
        ...
        public SPF1RecordTestSuite() throws IOException {
            ...
            while (i.hasNext()) {
                addTest(new SPF1RecordTest((SPF1RecordTestDef) tests.get(i
                        .next())));
            }
        }
